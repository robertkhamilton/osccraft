...
public class OscEntitySheep extends EntitySheep implements net.minecraftforge.common.IShearable
{
    public OscEntitySheep(World worldIn) {
		super(worldIn);
    ...
    */
     ...
     */
    /*
    public OscEntitySheep func_180491_b(EntityAgeable p_180491_1_)
    {
        OscEntitySheep entitysheep = (OscEntitySheep)p_180491_1_;
        OscEntitySheep entitysheep1 = new OscEntitySheep(this.worldObj);
    ...
    {
        int i = ((OscEntitySheep)p_175511_1_).getFleeceColor().getDyeDamage();
        int j = ((OscEntitySheep)p_175511_2_).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((OscEntitySheep)p_175511_1_).worldObj);
        int k;
