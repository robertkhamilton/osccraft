    ...
    if (isRunning) {
      try {
        ...
        Logger.printError("UdpClient.send",
                          ...
                          ", packetAddress: "+thePacket.getAddress().toString() + 
                          ", port: "+ thePacket.getPort() + 
                          ", socketAddress: "+thePacket.getSocketAddress().toString() +
                          ", getData: " + thePacket.getData().toString() +
                          ", getLength: " + thePacket.getLength() +
                          ", getOffset: " + thePacket.getOffset() +
                          ", packet.toString: " + thePacket.toString()                            
                          );
      }
    }
  }
